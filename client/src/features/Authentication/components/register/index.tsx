    ...
    return (
        <main className="register">
            ...
            <form className="register-form" onSubmit={handleSubmit(onRgister)}>
                ...
                <div className="form-field">
                    <TextField {...register("mobile")} error={errors.mobile?.message ? true : false} placeholder="Mobile"></TextField>
                    <span className="error">{errors.mobile?.message}</span>
                </div>

                <div className="form-field">
                    <TextField {...register("username")} error={errors.username?.message ? true : false} placeholder="Username"></TextField>
